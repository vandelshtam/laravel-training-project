                    ...
                    <div class="d-flex align-items-center container p-0">
                        <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                            <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                <img src="img/message.png" style="width: 35px;" alt="SmartAdmin WebApp" aria-roledescription="logo">
                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="/register" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="name" id="emailverify" class="form-control" placeholder="Имя" name="name" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                            <div class="help-block">Придумайте имя которое будет видно в вашем профиле</div>
                                        </div>
                                        <div class="form-group">
