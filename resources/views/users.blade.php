                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/edit/{{ $user->user_id }}">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="/confirm-password/{{ $user->user_id }}/{{ 'security' }}">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="/status/{{ $user->user_id }}">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/statusAdmin/{{ $user->user_id }}">
                                            <i class="fa fa-sun"></i>
                                        Установить роль</a>
                                        ...
                                        <a href="/confirm-password/{{ $user->user_id }}/{{ 'delete' }}" class="dropdown-item" onclick="return confirm('are you sure?');">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> {{ $user->location }}</address>
