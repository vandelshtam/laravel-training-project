...
<head>
    ...
    <link id="vendorsbundle" rel="stylesheet" media="screen, print" href="/laravel-training-project/resources/css/vendors.bundle.css">
    <link id="appbundle" rel="stylesheet" media="screen, print" href="/laravel-training-project/resources/css/app.bundle.css">
    ...
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            <a class="navbar-brand d-flex align-items-center fw-500" href="users.html"><img alt="logo" class="d-inline-block align-top mr-2" src="/laravel-training-project/resources/img/logo.png"> Учебный проект</a> <button aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarColor02" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
    ...
    <script src="/laravel-training-project/resources/js/vendors.bundle.js"></script>
    <script src="/laravel-training-project/resources/js/app.bundle.js"></script>
    <script>
