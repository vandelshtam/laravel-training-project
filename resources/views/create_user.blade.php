                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="occupation" value="{{old('occupation')}}">
                                </div>
                                <!-- position -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Должность</label>
                                    <input type="text" id="simpleinput" class="form-control" name="position" value="{{old('occupation')}}">
                                </div>
                                <!-- tel -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="location" value="{{old('location')}}">
                                </div>
                            </div>
                        </div>    
                    </div>
