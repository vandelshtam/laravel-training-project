...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="page_login.html">Выйти</a>
            </li>
            @else
            <li class="nav-item">
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="img/demo/avatars/avatar-m.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        {{ $user->name }} 
                                        <small class="text-muted mb-0">{{ $user->location }}</small>
                                    </h5>
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    ...
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> {{ $user->position }}
                                    </address>
                                </div>
                            </div>
                        </div>
